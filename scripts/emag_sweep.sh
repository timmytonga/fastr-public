...
for lr in 1e-1 1 2 5 10; do
  ...
  python main.py --optimizer $optimizer --lr $lr --storm_a_0 ${a0} --storm_ema_g --wandb
done

#for p in '1/2' '1/3' '1/4' '1/5'; do python main.py --optimizer fastrn --storm_p $p --lr 1 --storm_a_0 -1 --storm_ema_g --storm_beta1 0.9 --wandb; done
